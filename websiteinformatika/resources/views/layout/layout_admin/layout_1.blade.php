...
<html lang="en" data-bs-theme="auto">
  <head>
    ...
    <link href="{{ asset("assets_bootstrap/style.css")}}" rel="stylesheet" />
  ...
  <body>
    ...
    <script
      src="{{ asset ('assets_bootstrap/dist/js/bootstrap.bundle.min.js')}}"
    ...
    <script
      ...
      class="astro-vvvwv3sm"
    ></script>
    <script src="{{ asset('assets_bootstrap/dashboard.js')}}" class="astro-vvvwv3sm"></script>
  </body>
</html>
